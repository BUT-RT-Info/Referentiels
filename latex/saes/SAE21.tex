...
% Le description
\ajoutSdescription{
Le professionnel R\&T peut être sollicité pour construire et mettre en
place le réseau informatique d'une entreprise. La SAE se focalise sur
celui d'une petite structure, ayant besoin d'un réseau ``de petite
échelle'' : ce réseau s'appuie sur quelques équipements informatiques
``simples'' mais fondamentaux pour fournir à la structure un réseau
...
% Mots-clés
\ajoutSmotscles{Adressage IP, VLAN, VTP, routage inter-VLAN, NAT, PAT, ACL, DNS, HTTP, SSH, routage (vecteur de distance / état de lien), PXE, TFTP}
