...
Web, \ldots) qui permettent leur fonctionnement.\\[25pt]
...
Windows) pour lister les adresses \textabbrv{MAC} présentes dans le réseau local.\\[25pt]
On peut faire découvrir les outils pour connaître son adresse \textabbrv{IP}
Publique~: \url{https://github.com/VREMSoftwareDevelopment/WiFiAnalyzer.}\\[25pt]
