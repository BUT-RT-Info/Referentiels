...
\usepackage[pdfencoding=unicode, pdfusetitle, colorlinks=true, urlcolor=blue]{hyperref}
\usepackage{bookmark}
...
\fancypagestyle{BO}{%
  \fancyhf{}%
  \fancyfoot[L]{
    Bachelor Universitaire de Technologie «Réseaux \& Télécommunications» 1\iere année\\  
  \textcopyright~Ministère de l'Enseignement supérieur, de la Recherche et de l'Innovation 2021\\\url{http://www.enseignementsup-recherche.gouv.fr}}
  \fancyfoot[C]{~\\}
  \fancyfoot[R]{~\\\hspace*{4cm}\thepage}
}
...
%  PAGE DE GARDE OFFICIELLE EN PDF
\includepdf[pages=1]{img/PN-BUT_Couverture_RT_2021.pdf}
...
% XXX Annexe A: tableau du semestre 1 et semestre 2
% XXX avec heures et coefficients
% XXX (pdf format paysage)
% XXX 6 heures sur le projet de S2 => portfolio

% XXX Texte sur les SAE et le portfolio
% XXX c'est un PDF (à repasser en texte)

% XXX liste des SAE et ressources avec numéros de pages

% XXX => ajouter à la fin le réf. d'évaluation

% XXX => pied de page à changer
