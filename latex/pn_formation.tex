...
\input{synthese/referentiel_S1.tex}

%%%%%%%%%%%%%%%%%
%%% SEMESTRE 2 %%
%%%%%%%%%%%%%%%%%
\arrayrulecolor{black}
\input{synthese/referentiel_S2.tex}
...
%%%%%%%%%%%%%%%%%
\arrayrulecolor{black}
\input{synthese/referentiel_S3.tex}

%%%%%%%%%%%%%%%%%
%%% SEMESTRE 4 %%
%%%%%%%%%%%%%%%%%
\arrayrulecolor{black}
\input{synthese/referentiel_S4.tex}

%%%%%%%%%%%%%%%%%
%%% SEMESTRE 5 %%
%%%%%%%%%%%%%%%%%
\arrayrulecolor{black}
\input{synthese/referentiel_S5.tex}

%%%%%%%%%%%%%%%%%
%%% SEMESTRE 6 %%
%%%%%%%%%%%%%%%%%
\arrayrulecolor{black}
\input{synthese/referentiel_S6.tex}

%%%%%%%%%%%%%%%%%%%%%
%%% Complémentaire %%
%%%%%%%%%%%%%%%%%%%%%
\arrayrulecolor{black}
\input{synthese/referentiel_SC.tex}
