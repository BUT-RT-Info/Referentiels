\documentclass[10pt,french]{article} % lualatex
%\usepackage{fontspec} <- à remettre en place pour le référentiel définitif
%\usepackage{helvet} <- à remettre en place pour le référentiel définitif
\usepackage{arevtext}
...
\fancypagestyle{BO}{%
  \fancyhf{}%
  \fancyfoot[L]{\textcopyright~Black PN de la communauté RT}
  \fancyfoot[C]{~\\}
  \fancyfoot[R]{~\\Réseaux \& Télécommunications\hspace*{2cm}\thepage}
}

% Police <- à remettre en place pour le référentiel définitf
...
%, sous la direction du groupe de travail constitué de~:
%{\em Cléo Baras, Jean-Jacques Bascou,\\
%Christine Bolou-Chiaravalli, Anne-Sophie Capelle, Michel Gautero, Denis\\Genon-Catalot, Willy Guillemin, Said Hoceini, Fabrice Peyrard, Marie-Bernadette Piel, Emmanuel Viennet} \\
% et {\em Frédéric Drouhin} (Président de l'ACD).
\end{boitepagetitre}
...
\setcounter{tocdepth}{2} % Limite au subsection
...
\input{synthese/liste_saes_S1.tex}


\subsection{Ressources du semestre 1}
\input{synthese/liste_ressources_S1.tex}
...
\input{synthese/liste_saes_S2.tex}

\subsection{Ressources du semestre 2}
\input{synthese/liste_ressources_S2.tex}
...
\input{synthese/liste_saes_S3.tex}
%
\subsection{Ressources du semestre 3}
\input{synthese/liste_ressources_S3.tex}

\newpage
\input{referentiel_S3.tex}
...
\arrayrulecolor{black}
\section{Semestre 4}
\def\sem{D} % Le semestre 4

\subsection{SAÉs du semestre 4}
\input{synthese/liste_saes_S4.tex}

\subsection{Ressources du semestre 4}
\input{synthese/liste_ressources_S4.tex}

\newpage
\input{referentiel_S4.tex}
...
\arrayrulecolor{black}
\section{Semestre 5}
\def\sem{E} % Le semestre 3

\subsection{SAÉs du semestre 5}
\input{synthese/liste_saes_S5.tex}

\subsection{Ressources du semestre 5}
\input{synthese/liste_ressources_S5.tex}

\newpage
\input{referentiel_S5.tex}
...
\arrayrulecolor{black}
\section{Semestre 6}
\def\sem{F} % Le semestre 3

\subsection{SAÉs du semestre 6}
\input{synthese/liste_saes_S6.tex}

\subsection{Ressources du semestre 6}
\input{synthese/liste_ressources_S6.tex}

\newpage
\input{referentiel_S6.tex}
