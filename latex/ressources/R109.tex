...
cf.~https://pix.fr/competences) mais également des technologies mises en
œuvre pour délivrer ses contenus aux utilisateurs par le biais d'un
navigateur Web.}
...
% Mots-clés
\ajoutRmotscles{Web, HTML, CSS, client/serveur, codage de l'information}
