...
class Docx():
    ...
    def nettoie_acs(self):
        ...
        for comp in range(3):
            ...
            acs_avec_nom = devine_code_by_nom_from_dict(donnees, self.officiel.DATA_ACS) # récupère les codes en utilisant les noms
    ...
    def nettoie_code(self):
        ...
        if self.code:
            ...
            if len(codes) == 1:
                ...
                code_devine = get_code_from_nom_using_dict(self.nom, self.officiel.DATA_RESSOURCES)
                if code_devine:
    ...
    def nettoie_code(self):
        ...
        if self.code:
            ...
            if len(codes) == 1:
                ...
                code_devine = get_code_from_nom_using_dict(self.nom, self.officiel.DATA_SAES)
                if code_devine:
